...
nsMBCSGroupProber::nsMBCSGroupProber(PRUint32 aLanguageFilter)
{
  ...
  {
    mProbers[1] = new nsSJISProber(!(aLanguageFilter & NS_FILTER_CHINESE_SIMPLIFIED));  /* NP3 patch */
    mProbers[2] = new nsEUCJPProber(!(aLanguageFilter & NS_FILTER_CHINESE_SIMPLIFIED)); /* NP3 patch */
  }
  if (aLanguageFilter & NS_FILTER_CHINESE_SIMPLIFIED)
    mProbers[3] = new nsGB18030Prober(!(aLanguageFilter & NS_FILTER_JAPANESE));          /* NP3 patch */
