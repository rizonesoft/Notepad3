...
static const EncodingInfo kEncodingInfoTable[] = {
  ...
  { "Latin3", "ISO-8859-3", 
          UTF8}, // MSIE 6 does not support ISO-8859-3 (XSS issue)
  { "Latin4", "ISO-8859-4", ISO_8859_4},
  { "ISO-8859-5", "ISO-8859-5", ISO_8859_5},
  { "Arabic", "ISO-8859-6", ISO_8859_6},
  { "Greek", "ISO-8859-7", ISO_8859_7},
  { "Hebrew", "ISO-8859-8", 
          MSFT_CP1255}, // we do not endorse the visual order
  { "Latin5", "ISO-8859-9", ISO_8859_9},
  { "Latin6", "ISO-8859-10", 
          UTF8}, // MSIE does not support ISO-8859-10 (XSS issue)
  { "EUC-JP",  "EUC-JP", JAPANESE_EUC_JP},
  { "SJS", "Shift_JIS", JAPANESE_SHIFT_JIS},
  { "JIS", "ISO-2022-JP", 
          JAPANESE_SHIFT_JIS}, // due to potential confusion with HTML syntax chars
  { "BIG5", "Big5", CHINESE_BIG5},
  { "GB", "GB2312", 
          GBK},  // because GB2312 is quite old
{ "EUC-CN", "EUC-CN",    // Misnamed. Should be EUC-TW.
          CHINESE_BIG5}, // MSIE treats "EUC-CN" like GB2312, which is not EUC-TW,
                         // and EUC-TW is rare, so we prefer Big5 for output.
  { "KSC", "EUC-KR", KOREAN_EUC_KR},
  { "Unicode", "UTF-16LE", // Internet Explorer doesn't recognize "ISO-10646-UCS-2"
          UTF8},           // due to potential confusion with HTML syntax chars
  { "EUC", "EUC",  // Misnamed. Should be EUC-TW.
          CHINESE_BIG5},  // MSIE does not recognize "EUC" (XSS issue),
                          // and EUC-TW is rare, so we prefer Big5 for output.
  { "CNS", "CNS",         // Misnamed. Should be EUC-TW.
          CHINESE_BIG5},    // MSIE does not recognize "CNS" (XSS issue),
                          // and EUC-TW is rare, so we prefer Big5 for output.
  { "BIG5-CP950", "BIG5-CP950",  // Not an IANA name
          CHINESE_BIG5},   // MSIE does not recognize "BIG5-CP950" (XSS issue)
  ...
  { "ISO-8859-8-I", "ISO-8859-8-I", 
          MSFT_CP1255},  // Java does not support iso-8859-8-i
  { "VISUAL", "ISO-8859-8", 
          MSFT_CP1255},  // we do not endorse the visual order
  { "CP852", "cp852", 
          MSFT_CP1250},  // because cp852 is not as common
  { "CSN_369103", "csn_369103", 
          MSFT_CP1250},  // MSIE does not recognize "csn_369103" (XSS issue)
  { "CP1253", "windows-1253", MSFT_CP1253},
  { "CP866", "IBM866", 
          RUSSIAN_CP1251}, // because cp866 is not as common
  { "ISO-8859-13", "ISO-8859-13", 
          UTF8},  // because iso-8859-13 is not widely supported
  { "ISO-2022-KR", "ISO-2022-KR", 
          KOREAN_EUC_KR},  // due to potential confusion with HTML syntax chars
  { "GBK", "GBK", GBK},
  { "GB18030", "GB18030", GB18030},
  { "BIG5_HKSCS", "BIG5-HKSCS", 
          CHINESE_BIG5}, // because Big5-HKSCS is not widely supported
  ...
  { "JAGRAN", "jagran", 
          UTF8},  // we do not have an output converter for this font encoding
  { "MACINTOSH", "MACINTOSH", 
          ISO_8859_1}, // because macintosh is relatively uncommon
  { "UTF7", "UTF-7",
  ...
  { "HZ-GB-2312", "HZ-GB-2312", // due to potential confusion with HTML syntax chars
          GBK},  // because GB2312 is quite old
...
static const EncodingMap& GetEncodingMap() {
  ...
  encoding_map["gb-2312-80"] = CHINESE_GB;
