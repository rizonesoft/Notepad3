...
EDITLEXER lexAVS =
{
    ...
    &KeyWords_AVS, {
        ...
        { {SCE_AVS_OPERATOR}, IDS_LEX_STR_63132, L"Operator", L"fore:#7F007F", L"" },
        { {MULTI_STYLE(SCE_AVS_STRING,SCE_AVS_TRIPLESTRING,0,0)}, IDS_LEX_STR_63131, L"String", L"fore:#7B7B3E", L"" },
        { {SCE_AVS_NUMBER}, IDS_LEX_STR_63130, L"Number", L"fore:#007F7F", L"" },
        { {SCE_AVS_KEYWORD}, IDS_LEX_STR_63128, L"Keyword", L"bold; fore:#3737FF", L"" },
        { {SCE_AVS_IDENTIFIER}, IDS_LEX_STR_63129, L"Identifier", L"bold; fore:#6E6E6E", L"" },
        { {SCE_AVS_FILTER}, IDS_LEX_STR_63314, L"Filter", L"bold; fore:#3C3CFF", L"" },
        { {SCE_AVS_PLUGIN}, IDS_LEX_STR_63315, L"Plugin", L"bold; fore:#FF8040", L"" },
