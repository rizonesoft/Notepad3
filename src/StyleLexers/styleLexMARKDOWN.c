...
&KeyWords_MARKDOWN, {
    ...
    { {SCE_MARKDOWN_HEADER1}, IDS_LEX_STR_63320, L"Header 1", L"bold; fore:#009D9D; back:#DDFFDD; eolfilled", L"" },
    { {SCE_MARKDOWN_HEADER2}, IDS_LEX_STR_63321, L"Header 2", L"bold; fore:#009D9D; back:#DDFFDD; eolfilled", L"" },
    { {SCE_MARKDOWN_HEADER3}, IDS_LEX_STR_63322, L"Header 3", L"bold; fore:#009D9D; back:#DDFFDD; eolfilled", L"" },
    { {SCE_MARKDOWN_HEADER4}, IDS_LEX_STR_63323, L"Header 4", L"bold; fore:#009D9D; back:#DDFFDD; eolfilled", L"" },
    { {SCE_MARKDOWN_HEADER5}, IDS_LEX_STR_63324, L"Header 5", L"bold; fore:#009D9D; back:#DDFFDD; eolfilled", L"" },
    { {SCE_MARKDOWN_HEADER6}, IDS_LEX_STR_63325, L"Header 6", L"bold; fore:#009D9D; back:#DDFFDD; eolfilled", L"" },
    { {SCE_MARKDOWN_HDRTEXT}, IDS_LEX_STR_63367, L"Header Text", L"bold; fore:#B0005C; back:#DDFFDD; eolfilled", L"" },
