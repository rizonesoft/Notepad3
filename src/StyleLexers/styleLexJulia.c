...
EDITLEXER lexJulia =
{
    ...
    &KeyWords_Julia, {
        ...
        { { MULTI_STYLE(SCE_JULIA_KEYWORD2, SCE_JULIA_KEYWORD3, SCE_JULIA_KEYWORD4, 0) }, IDS_LEX_STR_63260, L"Keyword 2nd", L"bold; fore:#8A008A", L"" },
        ...
        { { SCE_JULIA_TYPEOPERATOR }, IDS_LEX_STR_63375, L"Type Operator", L"fore:#950095", L"" },
