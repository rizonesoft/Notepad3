...
&KeyWords_NULL, {
    ...
    /*  8 */ { {_STYLE_GETSTYLEID(STY_CUR_LN)}, IDS_LEX_STD_LN_BACKGR, L"Highlight Current Line", L"size:2; fore:#A0A0A0; back:#FFFF00; alpha:50", L"" },
...
&KeyWords_NULL,{
    ...
    /*  8 */ { {_STYLE_GETSTYLEID(STY_CUR_LN)}, IDS_LEX_2ND_LN_BACKGR, L"2nd Highlight Current Line", L"size:2; fore:#0000B0; back:#FFFF00; alpha:50", L"" },
