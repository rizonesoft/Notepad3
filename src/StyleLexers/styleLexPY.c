...
EDITLEXER lexPY =
{
    ...
    &KeyWords_PY, {
        ...
        { {MULTI_STYLE(SCE_P_TRIPLEDOUBLE,SCE_P_FTRIPLEDOUBLE,0,0)}, IDS_LEX_STR_63244, L"String Triple Double Quotes", L"fore:#008800", L"" },
        { {MULTI_STYLE(SCE_P_TRIPLE, SCE_P_FTRIPLE,0,0)}, IDS_LEX_STR_63245, L"String Triple Single Quotes", L"fore:#008800", L"" },
