...
EDITLEXER lexPY =
{
    ...
    &KeyWords_PY, {
        ...
        { {MULTI_STYLE(SCE_P_COMMENTLINE,SCE_P_COMMENTBLOCK,0,0)}, IDS_LEX_STR_63127, L"Comment", L"fore:#007F00", L"" },
        { {SCE_P_WORD}, IDS_LEX_STR_63128, L"Keyword", L"bold; fore:#00007F", L"" },
        { {SCE_P_WORD2}, IDS_LEX_STR_63260, L"Keyword 2nd", L"fore:#000088", L"" },
        { {SCE_P_IDENTIFIER}, IDS_LEX_STR_63129, L"Identifier", L"", L"" },
        { {SCE_P_ATTRIBUTE}, IDS_LEX_STR_63337, L"Attribute", L"fore:#008E8E", L"" },
        ...
        { {SCE_P_DECORATOR}, IDS_LEX_STR_63372, L"Decorator", L"fore:#F2B600", L"" },
        ...
        { {SCE_P_CLASSNAME}, IDS_LEX_STR_63246, L"Class Name", L"fore:#910048", L"" },
        EDITLEXER_SENTINEL
    }
};
