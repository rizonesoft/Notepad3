...
EDITLEXER lexDart =
{
    ...
    &KeyWords_Dart,{
        ...
        { {MULTI_STYLE(SCE_DART_TRIPLE_STRING_SQ, SCE_DART_TRIPLE_STRING_DQ, SCE_DART_TRIPLE_STRINGSTART, SCE_DART_TRIPLE_STRINGEND)}, IDS_LEX_STR_63131, L"TriQ-String", L"fore:#F08000", L"" },
