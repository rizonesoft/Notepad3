...
EDITLEXER lexDart =
{
    ...
    &KeyWords_Dart,{
        ...
        { {SCE_DART_ENUM}, IDS_LEX_STR_63384, L"Enumeration", L"fore:#FF8000", L"" },
        ...
        { {MULTI_STYLE(SCE_DART_OPERATOR, SCE_DART_OPERATOR2, 0, 0)}, IDS_LEX_STR_63132, L"Operator", L"fore:#B000B0", L"" },
