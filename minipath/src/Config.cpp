...
void InitDefaultSettings()
{
    ...
    Defaults.crCustom[0] = RGB(0, 0, 128);
    Defaults.crCustom[8] = RGB(255, 255, 226);
    Defaults.crCustom[1] = GetSysColor(COLOR_WINDOWTEXT);
    Defaults.crCustom[9] = GetSysColor(COLOR_WINDOW);
    Defaults.crCustom[2] = GetSysColor(COLOR_INFOTEXT);
    Defaults.crCustom[10] = GetSysColor(COLOR_INFOBK);
    Defaults.crCustom[3] = GetSysColor(COLOR_HIGHLIGHTTEXT);
    Defaults.crCustom[11] = GetSysColor(COLOR_HIGHLIGHT);
    Defaults.crCustom[4] = GetSysColor(COLOR_ACTIVECAPTION);
    Defaults.crCustom[12] = GetSysColor(COLOR_DESKTOP);
    Defaults.crCustom[5] = GetSysColor(COLOR_3DFACE);
    Defaults.crCustom[13] = GetSysColor(COLOR_3DFACE);
    Defaults.crCustom[6] = GetSysColor(COLOR_3DFACE);
    Defaults.crCustom[14] = GetSysColor(COLOR_3DFACE);
    Defaults.crCustom[7] = GetSysColor(COLOR_3DFACE);
    Defaults.crCustom[15] = GetSysColor(COLOR_3DFACE);
