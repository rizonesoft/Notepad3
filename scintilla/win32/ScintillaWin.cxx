...
class ScintillaWin :
	...
	bool DragThreshold(const Point &ptStart, const Point &ptNow);
	...
	bool PaintContains(const PRectangle &rc) const;
	...
	void NotifyDoubleClick(const Point &pt, int modifiers);
	...
	void Paste() override;
	void CreateCallTipWindow(const PRectangle &rc);
