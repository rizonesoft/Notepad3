...
public:
	explicit LexerVerilog(const char* languageName_ = "verilog", int language_ = SCLEX_VERILOG) :
	...
	static ILexer5* LexerFactorySysVerilog() {
		return new LexerVerilog("sysverilog", SCLEX_SYSVERILOG);
	}
...
extern const LexerModule lmSysVerilog(SCLEX_SYSVERILOG, LexerVerilog::LexerFactorySysVerilog, "sysverilog", verilogWordLists);
