; Notepad3 - Installer script x64compatible

; (c) Rizonesoft 2008-2025

; Requirements: Inno Setup 6.5.x or newer
; Inno Setup: https://jrsoftware.org/isdl.php

; Preprocessor related stuff
// if you compile an "alpha or beta version, then comment/un-comment the appropriate setting:
; #define VRSN=" alpha"
; #define VRSN=" beta"
...
// 6.3.0 in hex: 0x06005000
#if VER < 0x06005000
  #error Update your Inno Setup version (6.5.0 or newer)
#endif
...
#define app_publisher "Rizonesoft.com"
...
AppVerName={#app_name} {#app_version} ({#Arch}){#VRSN}
...
VersionInfoDescription={#app_name} ({#Arch}){#VRSN} Installer
VersionInfoProductName=Notepad3 by Rizonesoft
...
SignedUninstallerDir=.\Resources\Uninstall
...
[Languages]
Name: "enu"; MessagesFile: "Languages-mod\Default.isl"
Name: "afk"; MessagesFile: "Languages-mod\Afrikaans.isl"
Name: "bel"; MessagesFile: "Languages-mod\Belarusian.isl"
Name: "deu"; MessagesFile: "Languages-mod\German.isl"
Name: "ell"; MessagesFile: "Languages-mod\Greek.isl"
Name: "eng"; MessagesFile: "Languages-mod\EnglishBritish.isl"
Name: "esn"; MessagesFile: "Languages-mod\Spanish.isl"
Name: "fin"; MessagesFile: "Languages-mod\Finnish.isl"
Name: "fra"; MessagesFile: "Languages-mod\French.isl"
Name: "hin"; MessagesFile: "Languages-mod\Hindi.isl"
Name: "hun"; MessagesFile: "Languages-mod\Hungarian.isl"
Name: "ind"; MessagesFile: "Languages-mod\Indonesian.isl"
Name: "ita"; MessagesFile: "Languages-mod\Italian.isl"
Name: "jpn"; MessagesFile: "Languages-mod\Japanese.isl"
Name: "kor"; MessagesFile: "Languages-mod\Korean.isl"
Name: "nld"; MessagesFile: "Languages-mod\Dutch.isl"
Name: "plk"; MessagesFile: "Languages-mod\Polish.isl"
Name: "ptb"; MessagesFile: "Languages-mod\BrazilianPortuguese.isl"
Name: "ptg"; MessagesFile: "Languages-mod\Portuguese.isl"
Name: "rus"; MessagesFile: "Languages-mod\Russian.isl"
Name: "sky"; MessagesFile: "Languages-mod\Slovak.isl"
Name: "sve"; MessagesFile: "Languages-mod\Swedish.isl"
Name: "trk"; MessagesFile: "Languages-mod\Turkish.isl"
Name: "vit"; MessagesFile: "Languages-mod\Vietnamese.isl"
Name: "zhs"; MessagesFile: "Languages-mod\ChineseSimplified.isl"
Name: "zht"; MessagesFile: "Languages-mod\ChineseTraditional.isl"


[Messages]
enu.BeveledLabel=English (en-US)
afk.BeveledLabel=Afrikaans (af-ZA)
bel.BeveledLabel=Belarusian (be-BY)
deu.BeveledLabel=German (de-DE)
ell.BeveledLabel=Greek (el-GR)
eng.BeveledLabel=English (en-GB)
esn.BeveledLabel=Spanish (es-ES)
fin.BeveledLabel=Finnish (fi-FI)
fra.BeveledLabel=French (fr-FR)
hin.BeveledLabel=Hindi (hi-IN)
hun.BeveledLabel=Hungarian (hu-HU)
ind.BeveledLabel=Indonesian (id-ID)
ita.BeveledLabel=Italian (it-IT)
jpn.BeveledLabel=Japanese (ja-JP)
kor.BeveledLabel=Korean (ko-KR)
nld.BeveledLabel=Dutch (nl-NL)
plk.BeveledLabel=Polish (pl-PL)
ptb.BeveledLabel=Portuguese (pt-BR)
ptg.BeveledLabel=Portuguese (pt-PT)
rus.BeveledLabel=Russian (ru-RU)
sky.BeveledLabel=Slovak (sk-SK)
sve.BeveledLabel=Swedish (sv-SE)
trk.BeveledLabel=Turkish (tr-TR)
vit.BeveledLabel=Vietnamese (vi-VN)
zhs.BeveledLabel=Chinese (zh-CN)
zht.BeveledLabel=Chinese (zh-TW)
...
hin.msg_DeleteSettings=क्या आप भी {#app_name} की सेटिंग्स और थीम्स हटाना चाहते हैं?%n%nयदि आप {#app_name} को फिर से इंस्टॉल करने की योजना बना रहे हैं तो आपको उन्हें हटाने की आवश्यकता नहीं है।
#ifdef sse_required
hin.msg_simd_sse={#app_name} के इस निर्माण के लिए SSE एक्सटेंशन समर्थन वाले CPU की आवश्यकता है.%n%nआपके CPU में वे क्षमताएं नहीं हैं.
#endif
#ifdef sse2_required
hin.msg_simd_sse2={#app_name} के इस निर्माण के लिए SSE2 एक्सटेंशन समर्थन वाले CPU की आवश्यकता है.%n%nआपके CPU में वे क्षमताएं नहीं हैं.
#endif
hin.tsk_AllUsers=सभी उपयोगकर्ताओं के लिए
hin.tsk_CurrentUser=केवल वर्तमान उपयोगकर्ता के लिए
hin.tsk_Other=अन्य कार्य:
hin.tsk_ResetSettings={#app_name} की सेटिंग और थीम रीसेट करें
hin.tsk_RemoveDefault=Windows Notepad पुनर्स्थापित करें
hin.tsk_SetDefault=Windows Notepad को {#app_name} से बदलें
hin.tsk_StartMenuIcon=स्टार्ट मेनू शॉर्टकट बनाएँ
hin.tsk_LaunchWelcomePage=महत्वपूर्ण रिलीज़ जानकारी!
hin.tsk_RemoveOpenWith=संदर्भ मेनू से "{#app_name} के साथ खोलें" हटाएं
hin.tsk_SetOpenWith=संदर्भ मेनू में "{#app_name} के साथ खोलें" जोड़ें
...
ita.msg_DeleteSettings=Vuoi eliminare anche le impostazioni e i temi di {#app_name}? %n%nSe vuoi installare nuovamente {#app_name}, non è necessario eliminarli.
#ifdef sse_required
ita.msg_simd_sse=Questa versione di {#app_name} richiede una CPU con supporto per le estensioni SSE.%n%nLa CPU di queste computer non ha funzionalità SSE.
#endif
#ifdef sse2_required
ita.msg_simd_sse2=Questa versione di {#app_name} richiede una CPU con supporto per le estensioni SSE2.%n%nLa CPU di questo computer non ha funzionalità SSE2.
#endif
ita.tsk_AllUsers=Per tutti gli utenti
ita.tsk_CurrentUser=Solo per l'utente attuale
ita.tsk_Other=Altre attività:
ita.tsk_ResetSettings=Ripristina le impostazioni ed i temi di {#app_name}
ita.tsk_RemoveDefault=Ripristina l'associazione file con il Blocco note di Windows
ita.tsk_SetDefault=Sostituisci associazioni file Blocco note di Windows con {#app_name}
ita.tsk_StartMenuIcon=Crea un collegamento nel Menu Start
ita.tsk_LaunchWelcomePage=Visualizza info importanti sulla nuova versione!
ita.tsk_RemoveOpenWith=Rimuovi dal menu contestuale l'opzione "Apri con {#app_name}"
ita.tsk_SetOpenWith=Aggiungi al menu contestuale l'opzione "Apri con {#app_name}"
...
zhs.msg_DeleteSettings=是否希望删除 {#app_name} 的设置和主题？%n%n如果您稍后将要重新安装 {#app_name}，您不需要删除以前的配置。
#ifdef sse_required
zhs.msg_simd_sse=这个版本的 {#app_name} 需要支持 SSE 扩展指令集的 CPU。%n%n您的 CPU 缺少该支持。
#endif
#ifdef sse2_required
zhs.msg_simd_sse2=这个版本的 {#app_name} 需要支持 SSE2 扩展指令集的 CPU。%n%n您的 CPU 缺少该支持。
#endif
zhs.tsk_AllUsers=为所有用户
zhs.tsk_CurrentUser=仅为当前用户
zhs.tsk_Other=其它任务：
zhs.tsk_ResetSettings=重置 {#app_name} 的设置和主题
zhs.tsk_RemoveDefault=恢复 Windows 记事本
zhs.tsk_SetDefault=将 Windows 记事本替换为 {#app_name}
zhs.tsk_StartMenuIcon=在开始菜单中创建快捷方式
zhs.tsk_LaunchWelcomePage=重要更新信息！
zhs.tsk_RemoveOpenWith=从上下文菜单中删除"用 {#app_name} 打开"
zhs.tsk_SetOpenWith=在上下文菜单中添加"用 {#app_name} 打开"
zhs.reg_Open_with_NP3=用 {#app_name} 打开

zht.msg_DeleteSettings=是否希望刪除 {#app_name} 的設定和主題？%n%n如果您稍後將要重新安裝 {#app_name}，您不需要刪除以前的設定。
#ifdef sse_required
zht.msg_simd_sse=這個版本的 {#app_name} 需要支援 SSE 擴充指令集的 CPU。%n%n您的 CPU 缺少該支援。
#endif
#ifdef sse2_required
zht.msg_simd_sse2=這個版本的 {#app_name} 需要支援 SSE2 擴充指令集的 CPU。%n%n您的 CPU 缺少該支援。
#endif
zht.tsk_AllUsers=為所有使用者
zht.tsk_CurrentUser=僅為當前使用者
zht.tsk_Other=其它任務：
zht.tsk_ResetSettings=重置 {#app_name} 的設定和主題
zht.tsk_RemoveDefault=恢復 Windows 記事本
zht.tsk_SetDefault=將 Windows 記事本替換為 {#app_name}
zht.tsk_StartMenuIcon=於開始功能表中建立快捷方式
zht.tsk_LaunchWelcomePage=重要更新資訊！
zht.tsk_RemoveOpenWith=從上下文選單中刪除"用 {#app_name} 開啟"
zht.tsk_SetOpenWith=在上下文選單中新增"用 {#app_name} 開啟"
zht.reg_Open_with_NP3=用 {#app_name} 開啟
...
Source: "..\Notepad3.ini"; DestDir: "{app}\DefaultConfig"; Flags: ignoreversion
Source: "..\minipath.ini"; DestDir: "{app}\DefaultConfig"; Flags: ignoreversion
Source: "..\Themes\Dark.ini"; DestDir: "{app}\DefaultConfig\Themes"; Flags: ignoreversion
Source: "..\Themes\Obsidian.ini"; DestDir: "{app}\DefaultConfig\Themes"; Flags: ignoreversion
Source: "..\Themes\Sombra.ini"; DestDir: "{app}\DefaultConfig\Themes"; Flags: ignoreversion
; Batch script to copy config files to user's AppData (runs as original user, not elevated)
Source: "SetupUserConfig.cmd"; DestDir: "{app}"; Flags: ignoreversion
...
[Dirs]
; Note: User directories are created by SetupUserConfig.cmd running as the original user
...
; Note: User's Favorites path is set by SetupUserConfig.cmd running as original user


; ============================================================================
; POST-INSTALL: User Config Setup (runs as ORIGINAL user, not elevated admin)
; ============================================================================
; The runasoriginaluser flag ensures the script runs as the user who launched
; the installer, NOT as the elevated Administrator. This ensures config files
; are copied to the CORRECT user's %APPDATA% folder, even when a non-admin
; user installs using admin credentials from a UAC prompt.
; ============================================================================
[Run]
; Run config setup as original user - uses 'reset' parameter if reset_settings task is selected, otherwise 'install'
Filename: "{app}\SetupUserConfig.cmd"; Parameters: "reset"; WorkingDir: "{app}"; Flags: runhidden runasoriginaluser; Check: WizardIsTaskSelected('reset_settings')
Filename: "{app}\SetupUserConfig.cmd"; Parameters: "install"; WorkingDir: "{app}"; Flags: runhidden runasoriginaluser; Check: not WizardIsTaskSelected('reset_settings')
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.inf\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.inf\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "inffile"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.ini\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.ini\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "inifile"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.ps1\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.ps1\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "Microsoft.PowerShellScript.1"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.psd1\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.psd1\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "Microsoft.PowerShellData.1"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.psm1\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.psm1\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "Microsoft.PowerShellModule.1"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.log\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.log\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "txtfile"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.scp\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.scp\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "txtfile"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.txt\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.txt\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "txtfile"
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.wtx\UserChoiceLatest"; Flags: deletekey
...
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.wtx\UserChoiceLatest\ProgId"; ValueType: string; ValueName: "ProgId"; ValueData: "txtfile"
...
Filename: "https://rizonesoft.com/downloads/notepad3/update"; Flags: nowait postinstall shellexec skipifsilent unchecked; Description: "{cm:tsk_LaunchWelcomePage}"
...
Type: files; Name: "{#quick_launch}\{#app_name}.lnk"; OnlyBelowVersion: 6.2; Check: not WizardIsTaskSelected('quicklaunchicon') and IsUpgrade()
...
// ============================================================================
// Get the original (non-elevated) user's AppData path
// When running elevated, {userappdata} resolves to the admin's AppData.
// This function attempts to find the original user's profile.
// ============================================================================
function GetOriginalUserAppData(): String;
var
  UserName: String;
  ProfilePath: String;
begin
  // Try to get the original user from environment
  // SUDO_USER or the user who launched the installer
  UserName := GetEnv('USERNAME');
  
  // When elevated, we can try to get the profile from the logged-in user
  // via the explorer.exe process owner or USERPROFILE of the console session
  ProfilePath := GetEnv('USERPROFILE');
  
  if ProfilePath <> '' then
    Result := ProfilePath + '\AppData\Roaming'
  else
    // Fallback to the standard expansion (may be admin's path when elevated)
    Result := ExpandConstant('{userappdata}');
    
  Log('GetOriginalUserAppData: ' + Result);
end;

// Check if Notepad3's settings exist in the original user's AppData
// Note: During uninstall when elevated, {userappdata} points to admin's folder.
// We check both possible locations to be thorough.
function SettingsExistCheck(): Boolean;
var
  StandardPath: String;
  OriginalPath: String;
begin
  StandardPath := ExpandConstant('{userappdata}\Rizonesoft\Notepad3\Notepad3.ini');
  OriginalPath := GetOriginalUserAppData() + '\Rizonesoft\Notepad3\Notepad3.ini';
  
  // Check both paths - if either exists, settings are present
  Result := FileExists(StandardPath) or FileExists(OriginalPath);
...
// ============================================================================
// Run the SetupUserConfig.cmd script as the ORIGINAL user
// Uses ExecAsOriginalUser to ensure the script runs in the context of the
// user who launched the installer/uninstaller, not the elevated admin.
// This is critical for uninstall to affect the correct user's %APPDATA% folder.
// Commands: 'install', 'reset', 'uninstall'
// ============================================================================
procedure RunUserConfigScript(Command: String);
var
  ResultCode: Integer;
  ScriptPath: String;
begin
  ScriptPath := ExpandConstant('{app}\SetupUserConfig.cmd');
  
  if FileExists(ScriptPath) then
  begin
    Log('RunUserConfigScript: Executing "' + ScriptPath + '" with command: ' + Command);
    // ExecAsOriginalUser runs in the context of the user who launched the installer,
    // NOT the elevated admin. This ensures %APPDATA% resolves to the correct user's folder.
    if not ExecAsOriginalUser('cmd.exe', '/C ""' + ScriptPath + '" ' + Command + '"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode) then
      Log('RunUserConfigScript: ExecAsOriginalUser failed, trying Exec...');
    Log('RunUserConfigScript: Result code = ' + IntToStr(ResultCode));
  end
  else
    Log('RunUserConfigScript: Script not found at ' + ScriptPath);
end;
...
procedure RemoveReg();
begin
  // Remove specific shell extensions and OpenWith entries
  ...
  // Additional variations to ensure thorough removal
  if RegKeyExists(HKCR, '*\shell\Notepad3') then
    RegDeleteKeyIncludingSubkeys(HKCR, '*\shell\Notepad3');
  
  if RegKeyExists(HKCR, '*\shell\Edit with Notepad3') then
    RegDeleteKeyIncludingSubkeys(HKCR, '*\shell\Edit with Notepad3');

  // Check and remove custom shell entries if variables are set
  if (Length(PreviousDataOf_Open_with_NP3) > 0) and 
     RegKeyExists(HKCR, '*\shell\' + PreviousDataOf_Open_with_NP3) then
    RegDeleteKeyIncludingSubkeys(HKCR, '*\shell\' + PreviousDataOf_Open_with_NP3);
  
  if (Length(reg_Open_with_NP3) > 0) and 
     RegKeyExists(HKCR, '*\shell\' + reg_Open_with_NP3) then
    RegDeleteKeyIncludingSubkeys(HKCR, '*\shell\' + reg_Open_with_NP3);

  // Remove application-specific registry key if defined
...
procedure CurStepChanged(CurStep: TSetupStep);
  ...
  begin
    ...
    begin
      ...
      begin
        // Note: reset_settings task is handled by the [Run] section which executes
        // SetupUserConfig.cmd with 'reset' parameter using runasoriginaluser flag.
        // This ensures the files are reset in the correct user's %APPDATA% folder.
...
begin
  if CurUninstallStep = usUninstall then
    if SettingsExistCheck() then
      if UninstallSilent() then
        SettingsCleanUp := True  // Automatically delete settings in silent mode
      else
  ...
  begin
    if SettingsCleanUp then
      // Use RunUserConfigScript with 'uninstall' command - this uses ExecAsOriginalUser
      // to ensure the batch script runs in the original user's context, affecting
      // the correct user's %APPDATA% folder even when uninstaller runs elevated.
      RunUserConfigScript('uninstall');
