...
[Files]
Source: "{#bindir}\Release_x64_v143\Notepad3.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\minipath.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\grepWinNP3.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\Notepad3.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\minipath.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\grepWinNP3.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x64_v143\lng\mplng.dll"; DestDir: "{app}\lng"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\np3lng.dll"; DestDir: "{app}\lng"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\gwLng\*.lang"; DestDir: "{app}\lng\gwLng"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\af-ZA\mplng.dll.mui"; DestDir: "{app}\lng\af-ZA"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\af-ZA\np3lng.dll.mui"; DestDir: "{app}\lng\af-ZA"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\be-BY\mplng.dll.mui"; DestDir: "{app}\lng\be-BY"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\be-BY\np3lng.dll.mui"; DestDir: "{app}\lng\be-BY"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\de-DE\mplng.dll.mui"; DestDir: "{app}\lng\de-DE"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\de-DE\np3lng.dll.mui"; DestDir: "{app}\lng\de-DE"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\el-GR\mplng.dll.mui"; DestDir: "{app}\lng\el-GR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\el-GR\np3lng.dll.mui"; DestDir: "{app}\lng\el-GR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\en-GB\mplng.dll.mui"; DestDir: "{app}\lng\en-GB"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\en-GB\np3lng.dll.mui"; DestDir: "{app}\lng\en-GB"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\es-419\mplng.dll.mui"; DestDir: "{app}\lng\es-419"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\es-419\np3lng.dll.mui"; DestDir: "{app}\lng\es-419"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\es-ES\mplng.dll.mui"; DestDir: "{app}\lng\es-ES"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\es-ES\np3lng.dll.mui"; DestDir: "{app}\lng\es-ES"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\fr-FR\mplng.dll.mui"; DestDir: "{app}\lng\fr-FR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\fr-FR\np3lng.dll.mui"; DestDir: "{app}\lng\fr-FR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\hi-IN\mplng.dll.mui"; DestDir: "{app}\lng\hi-IN"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\hi-IN\np3lng.dll.mui"; DestDir: "{app}\lng\hi-IN"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\hu-HU\mplng.dll.mui"; DestDir: "{app}\lng\hu-HU"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\hu-HU\np3lng.dll.mui"; DestDir: "{app}\lng\hu-HU"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\id-ID\mplng.dll.mui"; DestDir: "{app}\lng\id-ID"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\id-ID\np3lng.dll.mui"; DestDir: "{app}\lng\id-ID"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\it-IT\mplng.dll.mui"; DestDir: "{app}\lng\it-IT"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\it-IT\np3lng.dll.mui"; DestDir: "{app}\lng\it-IT"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\ja-JP\mplng.dll.mui"; DestDir: "{app}\lng\ja-JP"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\ja-JP\np3lng.dll.mui"; DestDir: "{app}\lng\ja-JP"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\ko-KR\mplng.dll.mui"; DestDir: "{app}\lng\ko-KR"; Flags: ignoreversion; Check: Is64BitInstallMode()
...
Source: "{#bindir}\Release_x64_v143\lng\pl-PL\mplng.dll.mui"; DestDir: "{app}\lng\pl-PL"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\pl-PL\np3lng.dll.mui"; DestDir: "{app}\lng\pl-PL"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\pt-BR\mplng.dll.mui"; DestDir: "{app}\lng\pt-BR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\pt-BR\np3lng.dll.mui"; DestDir: "{app}\lng\pt-BR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\pt-PT\mplng.dll.mui"; DestDir: "{app}\lng\pt-PT"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\pt-PT\np3lng.dll.mui"; DestDir: "{app}\lng\pt-PT"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\ru-RU\mplng.dll.mui"; DestDir: "{app}\lng\ru-RU"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\ru-RU\np3lng.dll.mui"; DestDir: "{app}\lng\ru-RU"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\sk-SK\mplng.dll.mui"; DestDir: "{app}\lng\sk-SK"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\sk-SK\np3lng.dll.mui"; DestDir: "{app}\lng\sk-SK"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\sv-SE\mplng.dll.mui"; DestDir: "{app}\lng\sv-SE"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\sv-SE\np3lng.dll.mui"; DestDir: "{app}\lng\sv-SE"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\tr-TR\mplng.dll.mui"; DestDir: "{app}\lng\tr-TR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\tr-TR\np3lng.dll.mui"; DestDir: "{app}\lng\tr-TR"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\vi-VN\mplng.dll.mui"; DestDir: "{app}\lng\vi-VN"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\vi-VN\np3lng.dll.mui"; DestDir: "{app}\lng\vi-VN"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\zh-CN\mplng.dll.mui"; DestDir: "{app}\lng\zh-CN"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\zh-CN\np3lng.dll.mui"; DestDir: "{app}\lng\zh-CN"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\zh-TW\mplng.dll.mui"; DestDir: "{app}\lng\zh-TW"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x64_v143\lng\zh-TW\np3lng.dll.mui"; DestDir: "{app}\lng\zh-TW"; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\mplng.dll"; DestDir: "{app}\lng"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\np3lng.dll"; DestDir: "{app}\lng"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\gwLng\*.lang"; DestDir: "{app}\lng\gwLng"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\af-ZA\mplng.dll.mui"; DestDir: "{app}\lng\af-ZA"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\be-BY\mplng.dll.mui"; DestDir: "{app}\lng\be-BY"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\de-DE\mplng.dll.mui"; DestDir: "{app}\lng\de-DE"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\el-GR\mplng.dll.mui"; DestDir: "{app}\lng\el-GR"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\el-GR\np3lng.dll.mui"; DestDir: "{app}\lng\el-GR"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\en-GB\mplng.dll.mui"; DestDir: "{app}\lng\en-GB"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\es-419\mplng.dll.mui"; DestDir: "{app}\lng\es-419"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\es-419\np3lng.dll.mui"; DestDir: "{app}\lng\es-419"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\es-ES\mplng.dll.mui"; DestDir: "{app}\lng\es-ES"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\fr-FR\mplng.dll.mui"; DestDir: "{app}\lng\fr-FR"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\hi-IN\mplng.dll.mui"; DestDir: "{app}\lng\hi-IN"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\hu-HU\mplng.dll.mui"; DestDir: "{app}\lng\hu-HU"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\id-ID\mplng.dll.mui"; DestDir: "{app}\lng\id-ID"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\it-IT\mplng.dll.mui"; DestDir: "{app}\lng\it-IT"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\ja-JP\mplng.dll.mui"; DestDir: "{app}\lng\ja-JP"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\ko-KR\mplng.dll.mui"; DestDir: "{app}\lng\ko-KR"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\nl-NL\np3lng.dll.mui"; DestDir: "{app}\lng\nl-NL"; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: "{#bindir}\Release_x86_v143\lng\pl-PL\mplng.dll.mui"; DestDir: "{app}\lng\pl-PL"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\pt-BR\mplng.dll.mui"; DestDir: "{app}\lng\pt-BR"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\pt-PT\mplng.dll.mui"; DestDir: "{app}\lng\pt-PT"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\ru-RU\mplng.dll.mui"; DestDir: "{app}\lng\ru-RU"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\sk-SK\mplng.dll.mui"; DestDir: "{app}\lng\sk-SK"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\sv-SE\mplng.dll.mui"; DestDir: "{app}\lng\sv-SE"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\tr-TR\mplng.dll.mui"; DestDir: "{app}\lng\tr-TR"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\vi-VN\mplng.dll.mui"; DestDir: "{app}\lng\vi-VN"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\zh-CN\mplng.dll.mui"; DestDir: "{app}\lng\zh-CN"; Flags: ignoreversion; Check: not Is64BitInstallMode()
...
Source: "{#bindir}\Release_x86_v143\lng\zh-TW\mplng.dll.mui"; DestDir: "{app}\lng\zh-TW"; Flags: ignoreversion; Check: not Is64BitInstallMode()
