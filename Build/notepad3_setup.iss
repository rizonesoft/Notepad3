...
Source: {#bindir}\Release_x64_v142\lng\el-GR\mplng.dll.mui;         DestDir: {app}\lng\el-GR;                           Flags: ignoreversion;                         Check: Is64BitInstallMode()
Source: {#bindir}\Release_x64_v142\lng\el-GR\np3lng.dll.mui;        DestDir: {app}\lng\el-GR;                           Flags: ignoreversion;                         Check: Is64BitInstallMode()
...
Source: {#bindir}\Release_x64_v142\lng\es-419\mplng.dll.mui;        DestDir: {app}\lng\es-419;                          Flags: ignoreversion;                         Check: Is64BitInstallMode()
Source: {#bindir}\Release_x64_v142\lng\es-419\np3lng.dll.mui;       DestDir: {app}\lng\es-419;                          Flags: ignoreversion;                         Check: Is64BitInstallMode()
...
Source: {#bindir}\Release_x86_v142\lng\el-GR\mplng.dll.mui;         DestDir: {app}\lng\el-GR;                           Flags: ignoreversion;                         Check: not Is64BitInstallMode()
...
Source: {#bindir}\Release_x86_v142\lng\es-419\mplng.dll.mui;        DestDir: {app}\lng\es-419;                          Flags: ignoreversion;                         Check: not Is64BitInstallMode()
